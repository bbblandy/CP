...
def testPop():
    ...
    print(f"Expect popped customer to be p103. {c3}")
    print(f"Expect count property to be 2. {cList.count}")
    print(f"Expect len function to be 2. {len(cList)}")
    c1 = cList.pop(0)
    print(f"After pop with 0 parameter.  Expect just p102. {cList}")
    print(f"Expect popped customer to be p101. {c1}")
...
def testFind():
    ...
    index = cList.find(c2)
    print(f"Called find with customer object p102 as parameter.  Expect index to be 1. {index}")
    ...
    index = cList.find(c4)
    print(f"Called find with customer object p104 as parameter.  Expect index to be -1. {index}")
...
def testRemove():
    ...
    try:
        cList.remove(c4)
        print(f"Called remove with customer object p104 as parameter.  An exception should have been thrown but was not.")
    except ValueError:
        print(f"Called remove with customer object p104 as parameter.  An exception was expected and was thrown")
